...
# from dataset4 import ImageFolder
...
# test1_set = ImageFolder(test_dataset_path, transform=transform, target_transform=transform, triple_transform=triple_transform2, is_train=False)
